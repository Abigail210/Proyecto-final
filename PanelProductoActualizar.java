...
public class PanelProductoActualizar extends JPanel {
    ...
    public PanelProductoActualizar() {
        ...
        labeTitulo = new JLabel(Utils.ACTUALIZAR_PRODUCTO);
        ...
        buttonActualizar.setText(Utils.ACTUALIZAR);
        buttonActualizar.setBounds(10, 350, 100, 30);
